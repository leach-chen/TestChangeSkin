...
public class ViewHelper {
    ...
    @Nullable
    public static ViewOffsetHelper getOffsetHelper(@NonNull View view){
    ...
    @NonNull
    public static ViewOffsetHelper getOrCreateOffsetHelper(@NonNull View view){
        Object tag = view.getTag(R.id.view_offset_helper);
        if(tag instanceof ViewOffsetHelper){
            return (ViewOffsetHelper) tag;
        }else{
            ViewOffsetHelper ret = new ViewOffsetHelper(view);
            view.setTag(R.id.view_offset_helper, ret);
            return ret;
        }
    }
